...
with st.sidebar:
    ...
    <div style='padding:10px 0 24px;'>
        <div style='font-size:1.3rem;font-weight:700;color:#e6edf3;'>AI SpillGuard</div>
...
<div class='card' style='margin-bottom:28px;text-align:center;'>
    <div class='page-title' style='font-size:2.5rem;'>AI SpillGuard</div>
    <div class='page-subtitle' style='margin:8px auto 0;max-width:600px;'>
